...
public class ContractionHierarchy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Graph graph = new Graph(new File("/home/knor/route3/route-planning/newdenmark.graph"));

        ContractionHierarchy ch = new ContractionHierarchy(graph);

        ch.preprocess();
        ch.saveAugmentedGraph("/home/knor/route3/route-planning/06augmented_graph");
    }
}
